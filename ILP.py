...
if __name__ == '__main__':
    ...
    k = int(Data.readline()) # số lượng hàm ràng buộc
    obj = Data.readline().split() # Nhập hàm mục tiêu
    obj = [(int(x) if select == 'min\n' else -int(x)) for x in obj] # xử lí hàm mục tiêu
    ...
    if len(answer[1]) == 0:
        ...
        print("The result for the objective function is", answer[0] if select == 'min\n' else -answer[0])
        print("The value of the hidden x:", answer[1])
